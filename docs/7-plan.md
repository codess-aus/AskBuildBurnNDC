...
And the number one sentence I hear in that moment is: ‘I don’t know where to start.’
Not ‘I can’t do it.’ Just ‘I can’t see the next step.’
...
The other key piece on this slide is the Spec Kit idea: write down your engineering guidelines, security requirements, and compliance rules in a lightweight ‘constitution.’
That way, planning is not just ‘make a plan.’ It is ‘make a plan that matches how we build software here.’
