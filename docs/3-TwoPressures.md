...
That quote at the bottom, ‘I have no idea what I’m doing, and everyone’s going to find out,’ is funny because it’s true. Most of us have felt it. The problem is when a team’s culture turns that feeling into isolation instead of support.

Now delivery debt. This is what happens on the other end of the spectrum. Seniors face impossible expectations. They are expected to pick up the slack, but there is no slack. So they become the default escalation path, the reviewer, the fixer, the on call hero, and the person who carries the context.

And that is where burnout accelerates. Not because seniors cannot do the work, but because the work becomes unbounded.
